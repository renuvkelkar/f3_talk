  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int y = 0; y < height; y++) {
      for (int x = 0; x < width; x++) {
        ...
        // Check if the confidence is below a certain threshold to determine the background
        final double confidence = confidences[(y * width) + x];
        final double opacity = confidence >= 0.8 ? 0.0 : 1; // Adjust the threshold as needed
